      ...
      <section class="py-20 pb-32 bg-gradient-to-r from-indigo-100 via-red-100 to-yellow-100 rounded-xl shadow-xl my-5">
        <div class="relative max-w-6xl px-10 mx-auto">
          ...
          <div class="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
            <div class="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
              ...
              <div class="flex-1 flex-grow-0 pr-2 text-gray-200">
                <div class="relative flex items-center justify-end space-x-3">
                  <a href="#_" class="text-gray-500 hover:text-gray-700">
                    <svg
          ...
          <div class="grid grid-cols-1 gap-10 mt-10 md:grid-cols-2 xl:grid-cols-2">
            <div class="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div class="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                ...
                <div class="flex-1 min-w-0">
                  <a href="#_" class="focus:outline-none">
                    <p class="text-lg font-medium text-gray-900">Allen Sol</p>
                    <p class="text-sm text-gray-700 truncate">COO</p>
                  </a>
                </div>
                <div class="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div class="relative flex items-center justify-end space-x-3">
            ...
            <div class="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div class="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                ...
                <div class="flex-1 min-w-0">
                  <a href="#_" class="focus:outline-none">
                    <p class="text-lg font-medium text-gray-900">Paul Smith</p>
                    <p class="text-sm text-gray-700 truncate">Co-Founder</p>
                  </a>
                </div>
                <div class="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div class="relative flex items-center justify-end space-x-3">
              ...
              <div class="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                ...
                <div class="flex-1 min-w-0">
                  <a href="#_" class="focus:outline-none">
                    ...
                    <p class="text-sm text-gray-700 truncate">Lead Developer</p>
                  </a>
                </div>
                <div class="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div class="relative flex items-center justify-end space-x-3">
            ...
            <div class="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div class="relative z-10 flex items-center w-full h-full px-6 py-5 bg-gray-100 rounded-lg">
                ...
                <div class="flex-1 min-w-0">
                  <a href="#_" class="focus:outline-none">
                    <p class="text-lg font-medium text-gray-900">Sally Miles</p>
                    <p class="text-sm text-gray-700 truncate">Designer</p>
                  </a>
                </div>
                <div class="flex-1 flex-grow-0 pr-2 text-gray-200">
                  <div class="relative flex items-center justify-end space-x-3">
            ...
            <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-black rounded-lg">
                <div className="flex-shrink-0 mr-4">
                  <img
                    className="w-16 h-16 rounded-full"
                    src="https://images.unsplash.com/photo-1541881856704-3c4b2896c0f8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=800&crop=face&q=80"
                    alt="ytdtydufyfuyfy"
                  />
                </div>
            ...
            <div className="relative rounded-lg p-0.5 overflow-hidden bg-transparent shadow-sm hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
              <div className="relative z-10 flex items-center w-full h-full px-6 py-5 bg-black rounded-lg">
                <div className="flex-shrink-0 mr-4">
                  <img
                    className="w-16 h-16 rounded-full"
                    src="https://images.unsplash.com/photo-1517530094915-500495b15ade?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=800&crop=face&q=80"
                    alt="trtdtrfdhdh"
                  />
                </div>
                <div className="flex-1 min-w-0">
